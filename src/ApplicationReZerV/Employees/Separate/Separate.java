...
//       Policeman policeman = new Policeman(getRank(listEmployees.get(201)), getSurname(listEmployees.get(201)), getFirstName(listEmployees.get(201)), getShortName(listEmployees.get(201)), getPatronymic(listEmployees.get(201)),
//                getTokenID(listEmployees.get(201)), getPosition(listEmployees.get(201)), getUnit(listEmployees.get(201)) );
//       List<Policeman>list = new ArrayList<>();
//       list.add(policeman);
//        CommonMethods.writeList(list, pathResult);
//    }

    public List<Policeman> getListPoliceman(){
        List<Policeman> listPol = new ArrayList<>();
        for (int i = 0; i < listEmployees.size(); i++) {
            listPol.add(new Policeman(i+1,getRank(listEmployees.get(i)), getSurname(listEmployees.get(i)),
                    getFirstName(listEmployees.get(i)), getShortName(listEmployees.get(i)),
                    getPatronymic(listEmployees.get(i)),getTokenID(listEmployees.get(i)),
                    getPosition(listEmployees.get(i)),getUnit(listEmployees.get(i))));
        }
