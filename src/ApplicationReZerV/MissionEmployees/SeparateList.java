...
public class SeparateList {
    ...
    public List<String> separateListEmployees(){
        for (int i = 0; i < listEmployees.size(); i++) {
            if(listEmployees.get(i).length() > 60) {
                listSurname.add(setSurname(listEmployees.get(i)));
                listFirstName.add(setFirstName(listEmployees.get(i)));
                listPatronymic.add(setPatronymic(listEmployees.get(i)));
                listPosition.add(setPosition(listEmployees.get(i)));
                listShortname.add(setShortname(listEmployees.get(i)));
                listSurnameIsTenChar.add(addTenChar(listEmployees.get(i)));
           }
         }
    ...
    return list;} //создаем полную строку для записи в файл
    ...
    return list;} //создаем строку имя и отчество вместе
    ...
    public List<String> getListEmployees() {return listEmployees;    }

    public void setListEmployees(List<String> listEmployees) { this.listEmployees = listEmployees; }
